                            ...
                            <form role="form" method="post" action="manage/edit" enctype="multipart/form-data">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputFile"><?= ucwords($field->field); ?>
                                            (<?= ucwords($field->label); ?>):</label>
                                        <input type="text" name="<?= $field->field; ?>" class="form-control"
                                            value="<?= $object->$item; ?>" <?PHP if ($field->mandatory == 1) echo
                                        'required'; ?> />
                                    </div>
                                    <?PHP endif; ?>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputFile"><?= ucwords($field->field); ?>
                                            (<?= ucwords($field->label); ?>):</label>
                                        <input type="text" name="<?= $field->field; ?>" class="form-control"
                                            value="https://www.youtube.com/watch?v=<?= $object->$item; ?>" <?PHP if
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputFile"><?= ucwords($field->field); ?>
                                            (<?= ucwords($field->label); ?>):</label>
                                        <input type="number" name="<?= $field->field; ?>" class="form-control"
                                            value="<?= $object->$item; ?>" <?PHP if ($field->mandatory == 1) echo
                                        'required'; ?> />
                                    </div>
                                    <?PHP endif; ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="<?= $field->field; ?>" class="form-control textarea" <?PHP if
                                            ($field->mandatory == 1) echo 'required'; ?>><?= $object->$item; ?></textarea>
                                    </div>
                                    <?PHP endif; ?>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputFile"><?= ucwords($field->field); ?>
                                            (<?= ucwords($field->label); ?>):</label>
                                        <input type="email" name="<?= $field->field; ?>" class="form-control"
                                            value="<?= $object->$item; ?>" <?PHP if ($field->mandatory == 1) echo
                                        'required'; ?> />
                                    </div>
                                    <?PHP endif; ?>
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputFile"><?= ucwords($field->field); ?>
                                            (<?= ucwords($field->label); ?>):</label>
                                        <input type="password" name="<?= $field->field; ?>" class="form-control"
                                            value="<?= $object->$item; ?>" <?PHP if ($field->mandatory == 1) echo
                                        'required'; ?> />
                                    </div>
                                    <?PHP endif; ?>
