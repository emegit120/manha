...
<body>
    ...
    <section class="video fundo_cinza">
        <div>
            <video id="video_inicial" loop muted poster="site/img/Play.jpg" style="cursor: pointer;" controls>
                ...
                <div class="container">
                    ...
                    <div class="descricao">
                        ...
                        <div>
                            ...
                            <p class="uper"><strong>335m² a 435m²</strong></p>
                        </div>
                        <div class="garagens">
    ...
    <section id="stand" class="stand">

        <section class="fundo_azul">
            <div class="container">
                <article class="titulo">
                    <h2 data_anime="bottom">Stand <br />do Lemme</h2>
                    <hr data_anime="bottom" />
                </article>
            </div>
        </section>
        ...
        <section class="slideshow" data_anime_opacity="on" data_anime="bottom">
            <section class="desck">
                <section class="slides owl-carousel owl-theme">
                    <?PHP foreach($galeria_stand_banners as $banner): ?>
                    <article class="item">
                ...
                <section class="slides" style="padding:1px;">
                    <h3>Stand de Vendas</h3>
                    <h4>Rua Prof. Assis Gonçalves, 798 - Água Verde<br /><br />
                        Segunda a sexta - 09h30 às 17h<br />
                        Sábado, domingo e feriados 10h às 17h</h4>
                </section>
            </section>
            ...
            <section class="mobile">
                ...
                <section class="slides" style="padding:1px;">
                    <h3>Stand de Vendas</h3>
                    <h4>Rua Prof. Assis Gonçalves, 798 - Água Verde<br /><br />
                        Seg. à Sáb. - 09h às 18h<br />
                        Domingo - 10h às 17h</h4>
                </section>
            </section>
        </section>
    ...
    <section class="video_projetistas " data_anime_opacity="on">
        <div>¨
            ...
            <iframe playsinline id="ytplayer" type="text/html" width="100%"
                src="https://www.youtube.com/embed/fiSnsIQBW-I?autoplay=0&cc_load_policy=1&disablekb=1&enablejsapi=1&loop=1&color=white"
        ...
        <section class="slideshow" data_anime_opacity="on">
            ...
            <div class="ver_local">
                <a data-fancybox data-type="iframe"
                    href="https://www.google.com/maps/place/R.+Prof.+Assis+Gon%C3%A7alves,+798+-+%C3%81gua+Verde,+Curitiba+-+PR,+80620-250/@-25.4595685,-49.2845318,17z/data=!4m5!3m4!1s0x94dce4820476501f:0x1d7b68baf7f1374b!8m2!3d-25.4596072!4d-49.2837271">
...
"></iframe>
    ...
    <section class="andamento clearfix" dataMenu="on">
        <div class="container">
            ...
            <hr data_anime="bottom">
            <p class="verde">Atualizado em: <strong><?= $atualizadoem[0]->texto; ?></strong></p>
            ...
            <div class="btn-align">
                <a href="https://bidese.com.br/lemme/acompanhamento-de-obra" class="btn">CONFIRA
                        FOTOS DA OBRA</a>
            </div>
            </article>
    </section>
            ...
            <div class="flex">
                <div class="contato" data_anime="bottom">
                    <div>
                        ...
                        <p><b>Rua Prof. Assis Gonçalves, 798</b></p>
                        <p><b>Água Verde</b></p>
                    </div>
                    <div class="fone">
                        <p><b>Telefone</b></p>
                        <p>
                            ...
                            <a style="text-decoration:none;color: #003b4c;"
                                href="https://api.whatsapp.com/send?phone=554188163938&text=Ol%C3%A1!%20Acessei%20o%20site%20e%20me%20interessei%20pelo%20empreendimento%20Edif%C3%ADcio%20Lemme.%20Gostaria%20de%20falar%20com%20um%20atendente" target="_black">
                                <img width="32" src="site/img/whatsapp-para-lemme.svg">
                                <b>(41) 98816-3938</b>
                            </a>
    ...
    <div class="containerpopflex">
        <div class="containerpop">
            <div class="popup">
                <img src="https://bidese.com.br/lemme/popup/popup.jpg" title="Stand de Vendas" alt="Stand de Vendas"
                    class="img">
