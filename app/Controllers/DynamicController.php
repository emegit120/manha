...
Class DynamicController extends BaseController {
    ...
    public function index($entity) {
        ...
        if($entity === 'acompanhamento'){
            if(isset($this->data["user"])){
                $this->data["data"] = $dynamicModel->list($entity);
            }else{
                $this->data["data"] = $dynamicModel->list_periods($entity);
            }
        }else{
            $this->data["data"] = $dynamicModel->list($entity);
        }
    ...
    public function save() {
        ...
        if($entity_name === 'acompanhamento'){
            return redirect()->to('manage/' . $entity_name . '/?ano=' . $data['ano'] . '&mes=' . $data['mes']);
        }else{
    ...
    public function edit() {
        ...
        if($entity_name === 'acompanhamento'){
            return redirect()->to('manage/' . $entity_name . '/?ano=' . $this->request->getPost('ano') . '&mes=' . $this->request->getPost('mes'));
        }else{
            return redirect()->to('manage/' . $entity_name);
        }
